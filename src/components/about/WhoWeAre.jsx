...
export const WhoWeAreTab = () => (
  <Grid className="mb-3">
    <Paper>
      ...
      <CardMedia src={church} component="img" height={250} className="w-100 " />
    </Paper>
    <Grid>
      <Grid>
        ...
        <Typography variant="body1" className="p-2 my-2">
          Lakeview Africa Gospel Church is a christian based church situated in
          Nakuru, a house of prayer for all people, with a mission of spreading
          the gospel of Jesus Christ to all people across Nakuru County and
          beyond. We are part of a large and diverse Africa Gospel Church
      ...
      <Grid>
        ...
        <Typography variant="body1" className="p-2 my-2">
          To fulfill the Great commandment of the Lord Jesus Christ according to
          the Great Plan.
        </Typography>
