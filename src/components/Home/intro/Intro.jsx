...
const Intro = ({ churcharea = [], fast = {}, getDate }) => (
  <Box>
    <Grid
      container
      direction="row"
    ...
    >
      {/* grid one*/}
      <Grid item className="p-2 mb-1 mx-2 my-2" xs={12} md={3} lg={3}>
        <Card className="p-4">
          {" "}
      ...
      <Grid className=" mr-2    my-2  p-2 mb-1 " xs={12} md={4} lg={4} item>
        <Card className="p-1">
          ...
          <Typography>
            ...
            <q>
              {" "}
              So then,just as you received Christ Jest as Lord,continue to live
              in him,rooted and built in him.
            </q>
          </Typography>
    ...
    {new Date().getMonth() < 1 && <Fasting {...fast} getDate={getDate} />}
...
export const Fasting = ({
  ...
  const CalendarContainer = ({ children }) => <div>{children}</div>
  return (
    <Card className="w-100 mb-3 p-2" style={{ background: "#ccc" }}>
      <CardHeader
